...
o *conexiones*) que unen pares de vértices.
...
- **A** es el conjunto de aristas → las "líneas" que unen dos vértices:
  relaciones, rutas, vínculos, dependencias, etc.
:::
...
**JavaScript — estructura de un grafo**
...
intersecciones y calles. Todo eso sucede en milisegundos.
:::
...
nodos, un grafo puede clasificarse de distintas formas. Entender estas diferencias
...
entonces también existe entre B y A. La relación es completamente mutua.
...
Que exista conexión de A hacia B no significa que exista de B hacia A.
...
**Python — dirigido vs. no dirigido**
...
**JavaScript — dirigido vs. no dirigido**
...
::: {.callout-note icon="true"}
## Grafo No Ponderado
Las aristas solo indican **si existe o no** una conexión entre dos nodos.
...
::: {.callout-note icon="true"}
## Grafo Ponderado
Cada arista tiene un **peso o valor numérico** que representa alguna característica
...
**Python — ponderado vs. no ponderado**
...
**Java — ponderado vs. no ponderado**
...
**JavaScript — ponderado vs. no ponderado**
...
Puedes ir de cualquier nodo a cualquier otro, aunque sea pasando por intermediarios.
...
::: {.callout-note icon="true"}
##  Grafo No Conexo
Existen **grupos de nodos aislados** entre sí, llamados **componentes**.
...
**JavaScript — conexo vs. no conexo**
...
las aristas, no hay manera de volver a él.
...
construcción de software para saber en qué orden compilar los módulos.
:::
...
**JavaScript — cíclico vs. acíclico**
...
un nodo. Si el valor es `1`, hay conexión; si es `0`, no la hay.
...
ya que guarda todos los ceros también.
:::
...
con columnas `from` y `to`, puedes convertirla directamente en un grafo.
