...
```java
// NO DIRIGIDO
Map<String, List<String>> noDirigido = new HashMap<>();
noDirigido.put("Ana",   Arrays.asList("Bruno"));
noDirigido.put("Bruno", Arrays.asList("Ana"));

// DIRIGIDO
Map<String, List<String>> dirigido = new HashMap<>();
...
```java
// NO PONDERADO
Map<String, List<String>> noPonderado = new HashMap<>();
...
Map<String, List<String>> ponderado = new HashMap<>();
...
```java
Map<String, List<String>> noConexo = new HashMap<>();
...
```java
// CÍCLICO
Map<String, List<String>> ciclico = new HashMap<>();
...
// ACÍCLICO
Map<String, List<String>> aciclico = new HashMap<>();
